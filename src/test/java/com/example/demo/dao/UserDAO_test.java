...
public class UserDAO_test {
    ...
    public void getAllUser_test(){
        ...
        long number_1 = (userdao.getAllUser()).size();
        User user = new User();
        userdao.insert(user);
        long number_2 = (userdao.getAllUser()).size();
    ...
    public void insert_test(){
        ...
        long number_2 = (userdao.getAllUser()).size();
        Assert.assertEquals(number_1+1,number_2);
        Assert.assertEquals(java.util.Optional.of("Gabe Newell"),java.util.Optional.of(userdao.getUserbyEmail(user.getEmail()).getUsername()));
    }
    ...
    public void findUser_test(){
        ...
        user.setPasswd("steam");
        userdao.insert(user);
        userdao.givevip(user);  //findUser方法前置条件
        Assert.assertEquals(java.util.Optional.of("Gabe Newell"),java.util.Optional.of(userdao.findUser(user.getEmail(),user.getPasswd()).getUsername()));
    }
...
//        userdao.update(user); //error
////        Assert.assertEquals(java.util.Optional.of("修改测试"),java.util.Optional.of(userdao.findUser(user.getEmail(),user.getPasswd()).getUsername()));
//    }
    ...
    public void givevip_test(){
        ...
        user.setPasswd("steam");
        userdao.insert(user);
        Assert.assertEquals("NO",userdao.getUserbyEmail(user.getEmail()).getVip());
        userdao.givevip(user);
        Assert.assertEquals("YES",userdao.getUserbyEmail(user.getEmail()).getVip());
    }
}
